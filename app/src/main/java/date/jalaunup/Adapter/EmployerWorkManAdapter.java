...
public class EmployerWorkManAdapter extends RecyclerView.Adapter<EmployerWorkManAdapter.ViewHolder>{
    public WorkMan[] listdata;
    private Context mContext;
    public EmployerWorkManAdapter(Context context, WorkMan[] listdata)
    {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        View listItem= layoutInflater.inflate(R.layout.list_item_man_work, parent, false);
    ...
    {
        final WorkMan myListData = listdata[position];
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(mContext, employer_updateworkmanActivity.class);
