...
public class EmployerWorkManActivity extends AppCompatActivity {

    SessionManager session;
    List<WorkMan> myListData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_man_work);
        session = new SessionManager(getApplicationContext());
        session.checkLogin();
        String roleNew =  session.checkEmployerNew(session);
        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(EmployerWorkManActivity.this));
    ...
    public void GetRegisteredWork()
    {
        ...
        {
            ProgressDialog pdLoading = new ProgressDialog(EmployerWorkManActivity.this);
            ...
            protected void onPostExecute(String s)
            {
                ...
                try
                {
                    ...
                    WorkMan[] myArrayData = new WorkMan[myListData.size()];
                    myArrayData = myListData.toArray(myArrayData);

                    Log.e("Work List :",myListData.toString());

                    EmployerWorkManAdapter finalAdapter = new EmployerWorkManAdapter(EmployerWorkManActivity.this,myArrayData);
    ...
    {
        Intent i = new Intent(EmployerWorkManActivity.this,WelcomeeActivity.class);
       startActivity(i);
      finish();
    }
}